...
/**
 * @designpattern Template Method Pattern
 * 
 * @brief The LinkedListTest class demonstrates the Template Method Pattern.
 * 
 * @details
 * - The method `runAllTests()` defines the skeleton of the testing algorithm.
 * - It calls a series of fixed steps (`testCase1`, `testCase2`, `testCase3`) which are implemented as private methods.
 * - This pattern allows the overall structure of the test execution to remain unchanged while enabling flexibility in the individual test case implementations.
 * 
 * @benefits
 * - Promotes code reuse and consistency in test execution.
 * - Encapsulates the invariant parts of the algorithm while allowing variation in specific steps.
 */
