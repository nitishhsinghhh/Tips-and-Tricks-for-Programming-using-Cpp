...
iterators, vectors can use algorithms designed for other iterators as well.
...
| random_shuffle              | Randomly re-order elements in a range                                                                                         |
